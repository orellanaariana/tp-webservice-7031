...
import { TtsComponent } from './components/punto-d/tts.component'; // Reemplaza por tu componente real
...
export const routes: Routes = [
  ...
  { path: 'app-tts', component: TtsComponent }, // Reemplaza por tu componente real
